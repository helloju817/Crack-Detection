...
#tf.app.flags.DEFINE_string('recon_type', 'direct', 'residual or direct')
...
class model_builder:
    ...
    def enhancenet(self, inputs, is_training):
        with slim.arg_scope([slim.conv2d],
            ...
            #c_features = self.contour(inputs, features)
            #features = c_features
            for idx in range(10):
                if FLAGS.use_bn:
            ...
            #c_features = self.contour(inputs, features, upscale=True)
